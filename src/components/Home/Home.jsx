...
const Home = () => {
  ...
  return (
    ...
    >
      <div className="w-1/2 flex justify-center items-center pt-5 max-[600px]:w-full max-[600px]:mt-12 max-[600px]:pt-12">
        <img
          src={profile}
          alt="profile"
      ...
      <div className="w-1/2 flex items-center mt-5 max-[600px]:w-full max-[600px]:p-8">
        <div className="p-3">
